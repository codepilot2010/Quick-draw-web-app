...
function gotResult(error,results)
{
    if(error)
    {
        ...
        document.getElementById("p_yoursketch").innerHTML= "Your Sketch : "+drawn_sketch;
        document.getElementById("p_confidence").innerHTML= "Confidence : "+Math.round(results[0].confidence*100)+"%";
    }
}